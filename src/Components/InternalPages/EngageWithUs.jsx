  ...
  return (
    ...
    <div className="container mx-auto px-8 py-12">
      ...
      <section className="mb-6">
        ...
        <p className="mb-2">
          Dissertations in Cyber Security related subjects with special reference to Critical Information Infrastructure Protection are encouraged. The detailed proposal for the same may be sent on <a href="mailto:helpdesk2@nciipc.gov.in" className="text-blue-600">helpdesk2[at]nciipc[dot]gov[dot]in</a>.
        </p>
      </section>
      ...
      <section className="mb-6">
        <h3 className="text-xl font-semibold mb-2">Cyber Security Solution Providers</h3>
        <p className="mb-2">
          Indigenous developers of Cyber Security Solutions to include Hardware, Software, Secure Applications, System Hardening, and Security etc. may send details of their product/proposal on <a href="mailto:helpdesk2@nciipc.gov.in" className="text-blue-600">helpdesk2[at]nciipc[dot]gov[dot]in</a>.
        </p>
      </section>
      
      <section>
        <h3 className="text-xl font-semibold mb-2">Think Tanks</h3>
        <p className="mb-2">
          NCIIPC welcomes any suggestions/initiatives/proposals towards enhancing the cyber security posture of CII from Cyber Security Professionals, Think Tanks, and Regulators who may contact us through <a href="mailto:helpdesk2@nciipc.gov.in" className="text-blue-600">helpdesk2[at]nciipc[dot]gov[dot]in</a>.
        </p>
      </section>
    </div>
    </div>
