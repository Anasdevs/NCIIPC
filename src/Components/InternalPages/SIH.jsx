...
const SIH = () => {
  ...
  <img src={sihImg} className='h-[200px] w-full lg:h-[400px] lg:w-full' alt="SIH" srcSet="" />
      ...
      <p className="mb-4">
        In 2023, <a href='https://ntro.gov.in/' target='_blank' className="text-blue-600 font-semibold">NTRO</a> decided to participate in this hackathon and multiple centres took an initiative to come up with unique problem statements for the challenge.
      </p>
