...
const SIH = () => {
  return (
    <div className="container mx-auto px-8 py-12">
      ...
      <p className="mb-4">
        In 2023, <span className="text-blue-600 font-semibold">NTRO</span> decided to participate in this hackathon and multiple centres took an initiative to come up with unique problem statements for the challenge.
      </p>
      ...
      <p className="mb-4">
        <span className="text-blue-600 font-semibold">NTRO</span> was privileged by the Hon'ble Prime Minister interacting with one of our finalist teams through video conferencing.
      </p>
